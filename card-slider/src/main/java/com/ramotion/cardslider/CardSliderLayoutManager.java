...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    private int scrollLeft(int deltaX) {
        final int childCount = getChildCount();
        if (childCount == 0) {
            return 0;
        }
    ...
    private int getAllowedLeftDelta(@NonNull View view, int deltaX, int border) {
        final int viewLeft = getDecoratedLeft(view);
    ...
    private int getAllowedRightDelta(@NonNull View view, int deltaX, int border) {
        final int viewLeft = getDecoratedLeft(view);
