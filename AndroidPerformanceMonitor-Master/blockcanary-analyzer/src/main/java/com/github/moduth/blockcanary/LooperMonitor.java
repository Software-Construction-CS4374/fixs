...
class LooperMonitor implements Printer {
    ...
    public LooperMonitor(final BlockListener blockList, final long blockThMillis, final boolean stopDebug) {
        if (blockList == null) {
            throw new IllegalArgumentException("blockListener should not be null.");
        }
        mBlockListener = blockList;
        mBlockThresholdMillis = blockThMillis;
        mStopWhenDebugging = stopDebug;
    }

    @Override
    public void println(final String xStr) {
    ...
    private boolean isBlock(final long endTime) {
