...
final class BlockCanaryUtils {
     ...
     */
    public static String concernStackString(final BlockInfo blockInfo) {
        String result = "";
    ...
    public static boolean isBlockInfoValid(final BlockInfo blockInfo) {
        boolean isValid = !TextUtils.isEmpty(blockInfo.timeStart);
        isValid = isValid && blockInfo.timeCost >= 0;
        return isValid;
    }

    public static boolean isInWhiteList(final BlockInfo info) {
    ...
    private static String concernStackString(final String line) {
    ...
    private static String classSimpleName(final String stackLine) {
