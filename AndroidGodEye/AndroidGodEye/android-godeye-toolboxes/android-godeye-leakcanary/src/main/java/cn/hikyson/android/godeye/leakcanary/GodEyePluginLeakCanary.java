            ...
            public void run() {
                ...
                LeakCanary.setConfig(new LeakCanary.Config().newBuilder()
                        ...
                        .onHeapAnalyzedListener(new OnHeapAnalyzedListener() {
                            @Override
                            public void onHeapAnalyzed(final @NotNull HeapAnalysis heapAnalysis) {//FDS fix method arg could be final
                                ...
                                IteratorUtil.forEach(analysisSuccess.getAllLeaks().iterator(), new Consumer<shark.Leak>() {
                                    @Override
                                    public void accept(final shark.Leak leak) {//FDS fix method arg could be final
