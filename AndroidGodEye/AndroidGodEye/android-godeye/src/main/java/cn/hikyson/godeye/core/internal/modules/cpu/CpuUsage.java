...
public class CpuUsage {
    ...
    private static double filterCpuRatio(final double ratio) {//FDS fix method arg could be final
        if (ratio < 0 || ratio > 1) {
            return 0;
        }
        return ratio;
    ...
    @VisibleForTesting
    static CpuSnapshot parse(final String cpuRate,final String pidCpuRate) {//FDS fix method arg could be final
    ...
    @VisibleForTesting
    static int parseCPUIndex(final String line) {//FDS fix method arg could be final
    ...
    @VisibleForTesting
    static Map<String, Float> parseCpuRateOfDeviceAndTotalByShell(final String line) {//FDS fix method arg could be final
    ...
    @VisibleForTesting
    static float parseCpuRateOfAppByShell(final String line, final int cpuIndex,final Float cpuTotal) {//FDS fix method arg could be final
