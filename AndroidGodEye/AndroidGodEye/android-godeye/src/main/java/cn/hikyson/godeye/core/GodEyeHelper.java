...
public class GodEyeHelper {
     ...
     */
    public static void onPageLoaded(final Object page) throws UninstallException {
     ...
     * @throws UninstallException
     */
    public static void onFragmentPageVisibilityChange(final Object fragmentPage, final boolean visible) throws UninstallException {
     ...
     * @throws UninstallException
     */
    public static void onAppStartEnd(final StartupInfo startupInfo) throws UninstallException {
     ...
     * @throws UninstallException
     */
    public static void onNetworkEnd(final NetworkInfo networkInfo) throws UninstallException {
     ...
     * @throws UninstallException
     */
    public static void startMethodCanaryRecording(final String tag) throws UninstallException {
     ...
     * @throws UninstallException
     */
    public static void stopMethodCanaryRecording(final String tag) throws UninstallException {
        final MethodCanary methodCanary = GodEye.instance().getModule(GodEye.ModuleName.METHOD_CANARY);
     ...
     * @throws UninstallException
     */
    public static boolean isMethodCanaryRecording(final String tag) throws UninstallException {
        final MethodCanary methodCanary = GodEye.instance().getModule(GodEye.ModuleName.METHOD_CANARY);
     ...
     * @param appInfoConext
     */
    public static void setMonitorAppInfoConext(final AppInfoConext appInfoConext) {
     ...
     * @param port
     */
    public static void startMonitor(final int port) {
