...
public class NotifierTest {
	NotifierTest(){}//FDS fix at least one constructor
    @Before
    ...
    private void notice() {
        ...
        int identif = Notifier.notice(ApplicationProvider.getApplicationContext(), Notifier.createNoticeId(), notification);
        ThreadHelper.sleep(10);
        Notifier.cancelNotice(ApplicationProvider.getApplicationContext(), identif);
