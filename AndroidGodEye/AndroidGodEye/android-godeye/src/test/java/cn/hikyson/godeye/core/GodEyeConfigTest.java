...
public class GodEyeConfigTest {
	GodEyeConfigTest(){}//FDS at least one constructor
    @Before
    ...
    public void fromAssets() {
        ...
        try {
            Mockito.doAnswer(new Answer() {
                @Override
                public Object answer(final InvocationOnMock invocation) throws Throwable {//FDS fix method arg could be final
    ...
    private void assertConfig(final GodEyeConfig config) {//FDS fix mehtod arg could be final
