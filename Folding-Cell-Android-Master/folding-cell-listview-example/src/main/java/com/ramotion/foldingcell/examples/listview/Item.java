...
/**
 * fixed all methodargument could be final code style violations
 * fixed all LongVariables code style violations
 * fixed all short variables code style violations
 * fixed all controlstatementbraces (8 total) code style violations
 */
/**
...
public class Item {
    ...
    public Item(final String price, final String pledgePrice, final String fromAddress, final String toAddress,final int requestsCount,final String date, final String time) {
        this.price = price;
    ...
    public void setPledgePrice(final String pledgePrice) {
        this.pledgePrice = pledgePrice;
    }
    ...
    public void setRequestsCount(final int requestsCount) {
        this.requestsCount = requestsCount;
    }
    ...
    public void setRequestBtnClickListener(final View.OnClickListener requestBtnClk) {
        this.requestBtnClickListener = requestBtnClickListener;
    }

    @Override
    public boolean equals(final Object obj) {//NEF shortvariable fixed o-> obj
        if (this == obj) {
        	return true;
        }
        ...
        if (requestsCount != item.requestsCount) {
        	return false;
        }
